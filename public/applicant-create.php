...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach (['last_name', 'first_name', 'middle_name', 'address', 'course_degree', 'school_name', 'school_address'] as $upperKey) {
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6 mt-5">
      ...
      <div class="grid sm:grid-cols-2 gap-4">
        ...
        <div x-show="completion === 'Not Graduated'" x-cloak :data-conditional-hidden="completion !== 'Not Graduated' ? '1' : null" class="sm:col-span-2">
          ...
          <input type="text" name="highest_year_level_units" :required="completion === 'Not Graduated'" placeholder="e.g. Grade 12, 3rd Year College, 72 Units" value="<?= e($old['highest_year_level_units']) ?>"
                 class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:ring-2 focus:ring-brand-100 focus:border-brand-500 outline-none">
        ...
        <div x-show="completion === 'Graduated'" x-cloak :data-conditional-hidden="completion !== 'Graduated' ? '1' : null">
          ...
          <input type="date" name="date_graduated" :required="completion === 'Graduated'" max="<?= date('Y-m-d') ?>" value="<?= e($old['date_graduated']) ?>"
                 class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:ring-2 focus:ring-brand-100 focus:border-brand-500 outline-none">
        ...
        <div x-show="completion === 'Graduated'" x-cloak :data-conditional-hidden="completion !== 'Graduated' ? '1' : null">
          ...
          <input type="text" name="course_degree" :required="completion === 'Graduated'" value="<?= e($old['course_degree']) ?>"
                 class="uppercase-field uppercase w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:ring-2 focus:ring-brand-100 focus:border-brand-500 outline-none">
        ...
        <div x-show="completion === 'Graduated'" x-cloak :data-conditional-hidden="completion !== 'Graduated' ? '1' : null">
          ...
          <input type="text" name="school_name" :required="completion === 'Graduated'" value="<?= e($old['school_name']) ?>"
                 class="uppercase-field uppercase w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:ring-2 focus:ring-brand-100 focus:border-brand-500 outline-none">
        ...
        <div x-show="completion === 'Graduated'" x-cloak :data-conditional-hidden="completion !== 'Graduated' ? '1' : null">
          ...
          <textarea name="school_address" :required="completion === 'Graduated'" rows="2"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6 mt-5">
      ...
      <div class="grid sm:grid-cols-2 gap-4">
        ...
        <div x-show="eligibility === 'Eligible' && eligType === 'Other Eligibility'" x-cloak :data-conditional-hidden="!(eligibility === 'Eligible' && eligType === 'Other Eligibility') ? '1' : null" class="sm:col-span-2">
          ...
          <input type="text" name="other_eligibility_type" :required="eligibility === 'Eligible' && eligType === 'Other Eligibility'" maxlength="150" value="<?= e($old['other_eligibility_type']) ?>"
                 class="uppercase-field uppercase w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:ring-2 focus:ring-brand-100 focus:border-brand-500 outline-none">
